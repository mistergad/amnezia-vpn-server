...
class NativeAmneziaWGProvisioner(Provisioner):
    ...
    def __init__(self, settings: Settings):
        self.settings = settings
        # HTTP requests and the periodic reconciler share this instance. Keep
        # every peer mutation atomic so awg-quick cannot persist an
    ...
    def _server_metadata(self) -> tuple[str, dict[str, str]]:
        """Cache AWG2 server values that stay constant until service restart."""
